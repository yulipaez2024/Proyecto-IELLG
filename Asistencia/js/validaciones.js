...
//validar formulario asistencia estudiantes

function validarFormulario_asistencia() {
  var id_asistencia = document.getElementById("id-asistencia").value;
  var nombre_asistencia = document.getElementById("nombre-asistencia").value;
  var fecha = document.getElementById("fecha").value;
  var curso_asistencia = document.getElementById("curso-asistencia").value;
  var asistio = document.getElementById("asistio");
  var falto = document.getElementById("falla");

  if (id_asistencia == "") {
    alert("Por favor, ingresa id del estudiante.");
    return false; // Detiene el envío del formulario
  }
  if (nombre_asistencia == "") {
    alert("Por favor, ingresa el nombre completo del estudiante.");
    return false; // Detiene el envío del formulario
  }
  if (fecha == "") {
    alert("Por favor, ingresa la fecha de hoy.");
    return false; // Detiene el envío del formulario
  }
  if (curso_asistencia === "" || curso_asistencia === "a") {
    alert("Por favor, seleccione el curso del estudiante.");
    return false; // Detiene el envío del formulario
  }

  if (!asistio.checked && !falto.checked) {
    alert("Por favor, selecciona si el estudiante asistió o faltó.");
    return false;
  }
